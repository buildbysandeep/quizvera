...
const Question = ({
  ...
  return (
    <div>
      <div className={`flex flex-col gap-1 group relative rounded border border-gray-400 hover:border-black p-1`}>
        <div className="flex flex-col font-medium">
          <div className="flex gap-2 text-base ">
            ...
            <div className="min-w-0 w-full">
              ...
              {question.snippet && <CodeBlock lang={question.snippetLang || "plaintext"}>{question.snippet}</CodeBlock>}
            </div>
          </div>
          <RadioGroup
        ...
        {translationEnabled && (
          <div className="flex flex-col border-t border-dashed border-gray-500 pt-1">
